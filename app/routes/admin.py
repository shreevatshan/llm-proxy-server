    ...
    try:
        ...
        if existing:
            ...
            credentials = await create_provider_credentials(
                ...
                subscription_id=provider_data.subscription_id,
                resource_group=provider_data.resource_group,
        ...
        for provider_data in data.get("providers", []):
            try:
                ...
                credentials = await create_provider_credentials(
                    ...
                    resource_group=provider_data.get("resource_group"),
                    account_name=provider_data.get("account_name"),
